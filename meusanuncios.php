...
try {
    ...
    $url = "https://api.imoideal.com/source/prd/get-posts/" . $_SESSION['USER']['userid'];
...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container" style="min-height: 400px;">
            ...
            <button onclick="AbrirLink('newpost');" class="btn btn-outline-danger w-100 mb-4" type="submit">Novo Anúncio</button>
            <div class="row anuclinks">
                <div class="col-md mb-4">
                    ...
                    if (empty($anuncios)) {
                        echo "<h5 class='w-100 text-center text-muted'>(Sem anúncios)</h5>";
                    } else {
                        foreach ($anuncios as $a) {
                            ...
                            echo "</div>";
                            echo "<div class='col-sm-1 opcs-anunc'>";
                            echo "<div class='edit-anunc'><i class='fa-regular fa-pen-to-square'></i></div>";
                            echo "<div class='del-anunc'><i class='fa-regular fa-trash-can'></i></div>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
                            echo "</div>";
