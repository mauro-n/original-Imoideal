        ...
        <script>
            window.onload = function () {
                const ui = SwaggerUIBundle({
                    url: "openapi.json", // Arquivo JSON
//                    url: "asyncapi2.json", // Arquivo JSON
                    dom_id: '#swagger-ui', //O ID do elemento HTML onde o Swagger UI será renderizado
                    deepLinking: true, // Habilita a capacidade de usar links profundos para navegar na documentação.
                    presets: [
